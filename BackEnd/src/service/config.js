...
class KafkaConfig{
    ...
    async consume(topic,callback){
        try{
            ...
            const consumerPromise = new Promise((resolve, reject) => {
                // Logic consume tin nhắn
                // Khi offset commit thành công, resolve promise
                resolve();
            });
            // Thêm Promise vào mảng consumerPromises
    ...
    async waitForAllConsumers() {
        // Chờ cho tất cả các consumerPromise được resolve
